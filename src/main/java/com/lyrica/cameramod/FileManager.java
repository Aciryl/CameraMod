...
public class FileManager {
	public File file;
	private final String filename = "CameraMod.dat";
	...
	public LinkedList<String> getStringListData(String key) {
		String[] string = data.get(key).split(",");
	...
	public void setStringListData(String key, LinkedList<String> value) {
		String string = "";
		for (String s : value) {
			string += s;
			string += ", ";
