...
public class Transformer_EntityLivingBase implements IClassTransformer, Opcodes {
	public static final String TARGET = "net.minecraft.entity.EntityLivingBase";
	...
	public byte[] transform(String name, String transformedName, byte[] bytes){
		...
		ClassVisitor cv = new ClassAdapter_EntityLivingBase(cw);
